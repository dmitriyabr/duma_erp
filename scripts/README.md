...
Наполнение базы **реалистичными демо-данными** школьной жизни (Kenya): пользователи, классы, термы, сборы по классам/зонам, ученики с именами и опекунами, счета (частично оплаченные/оплаченные/выставленные), платежи и аллокации, закупки, один expense claim и компенсация, склад (форма).

Данные не случайные — подобраны так, чтобы отчёты и дашборд выглядели осмысленно.
