...
export const navItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Procurement Summary', path: '/reports/procurement-summary', roles: adminRoles },
      { label: 'Inventory Valuation', path: '/reports/inventory-valuation', roles: adminRoles },
      { label: 'Low Stock Alert', path: '/reports/low-stock-alert', roles: adminRoles },
      { label: 'Stock Movement Report', path: '/reports/stock-movement', roles: adminRoles },
      { label: 'Compensation Summary', path: '/reports/compensation-summary', roles: adminRoles },
      { label: 'Expense Claims by Category', path: '/reports/expense-claims-by-category', roles: adminRoles },
      { label: 'Revenue per Student Trend', path: '/reports/revenue-trend', roles: adminRoles },
      { label: 'Payment Method Distribution', path: '/reports/payment-method-distribution', roles: adminRoles },
      { label: 'Term Comparison', path: '/reports/term-comparison', roles: adminRoles },
      { label: 'KPIs & Metrics', path: '/reports/kpis', roles: adminRoles },
    ],
  },
  {
    label: 'Audit Log',
