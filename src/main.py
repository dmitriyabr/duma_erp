...
from src.modules.billing_accounts.router import router as billing_accounts_router
...
from src.modules.withdrawals.router import router as withdrawals_router
...
def create_app() -> FastAPI:
    ...
    app.include_router(billing_accounts_router, prefix="/api/v1")
